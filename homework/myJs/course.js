...
function callTable() {
    $('#example1').Tabledit({
        ...
        columns: {
            identifier: [0, 'id',],
            editable: [[1, 'name'],
                       [2, 'week','{"1":"周一","2":"周二","3":"周三","4":"周四","5":"周五"}'],
                       [3, 'time','{"1":"第一节8：00-8：50","2":"第二节9：00-9：50","3":"第三节10：10-11：00","4":"第四节11：10-12：00","5":"第五节13：30-14：20","6":"第六节14：30-15：20","7":"第七节15：30-16：20","8":"第八节16：30-17：20"}']]
        },
        ...
        if (data.msg == "SUCCESS") {
            $.each(data.data, function(key,value) {
                $('#mytdbody').append(
                    ...
                    "<td class='tabledit-view-mode'><span class='tabledit-span'>"+value[1]+"</span><input class='tabledit-input form-control input-sm' type='text' name='name' value="+value[1]+" style='display: none;' disabled='' /></td> " +
                    "<td class='tabledit-view-mode'><span class='tabledit-span'>"+week[value[2]]+"</span><input class='tabledit-input form-control input-sm'type='text' name='week' value="+value[2]+" style='display: none;' disabled='' /></td> " +
                    "<td class='tabledit-view-mode'><span class='tabledit-span'>"+time[value[3]]+"</span><input class='tabledit-input form-control input-sm'type='text' name='time' value="+value[3]+" style='display: none;' disabled='' /></td>" +
                    "</tr>"
                );
                $('#mytdbody2').append(
                    "<tr id="+value[0]+"> " +
    ...
    $("#myaddrow").click(function () {
        ...
        if (v == "" || v == null || !v) {
            $('#mytdbody').append(
                ...
                "<td class='tabledit-view-mode'><span class='tabledit-span'></span><input class='tabledit-input form-control input-sm' type='text' name='name' style='display: none;' disabled='' value=''/></td> " +
                "<td class='tabledit-view-mode'><span class='tabledit-span'></span><input class='tabledit-input form-control input-sm'type='text' name='week' style='display: none;' disabled='' value=''/></td>" +
                "<td class='tabledit-view-mode'><span class='tabledit-span'></span><input class='tabledit-input form-control input-sm'type='text' name='time' style='display: none;' disabled='' value=''/></td>" +
                "</tr>"
            );
            callTable();
        } else {
